    ...
    ui(new Ui::WeatherWidget)
{
    ...
    weather=new Weather(QStringLiteral("合肥"));   //默认城市为合肥
    ...
    ui->lineEditCityName->setText("合肥");
    ui->tabWidget->setCurrentWidget(ui->tab);

    ui->tabWidget->setTabText(0,"今日天气");
    ui->tabWidget->setTabText(1,"昨日/预计天气");
    ui->tableWidget->setColumnWidth(0,250);   //添加四列
    ui->tableWidget->setColumnWidth(1,250);
    ui->tableWidget->setColumnWidth(2,300);
    ui->tableWidget->setColumnWidth(3,275);
...
//                );
   ...
   ui->tableWidget->verticalHeader()->setDefaultSectionSize(75);  //设置行高 （除表头外）
